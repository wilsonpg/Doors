    ...
    dragonMoveSetup(){
     ...
     async getUserAttack(){
        return new Promise(async (resolve, reject) => {
            const userAttackCountResponse = await fetch(`http://localhost:3000/user/attack/count`);
            ...
            const response = await fetch('http://localhost:3000/user/attack/info/' + attacks);
     ...
     async getDragonAttack(){
        return new Promise(async (resolve, reject) => {
            const dragonAttackCountResponse = await fetch(`http://localhost:3000/dragon/attack/count`);
            ...
            const response = await fetch('http://localhost:3000/dragon/attack/info/' + randomAttack);
...
class PurpleDoorGame {
    ...
    async getRiddle(riddleCount) {
            return new Promise(async (resolve, reject) => {
                ...
                const response = await fetch('http://localhost:3000/riddle/' + randomRiddle);
    ...
    async getColor(color) {
        return new Promise(async (resolve, reject) => {
            ...
            const response = await fetch('http://localhost:3000/color/' + randomColor);
